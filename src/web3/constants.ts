...
export const CONTRACTS = {
	...
	[Chain.GOERLI]: {
		NuggftV1: lower('0x694200008FaB2B40054C3c0762f2f34505e484E6'),
		xNuggftV1: lower('0x0d1e49490bC70e7F2Ba594033600463a5Ab41580'),
		DotnuggV1: lower('0x5529C5229B59f7E49d0C2292109Ae14b584e7cfF'),
		Genesis: 7341120,
		Interval: 64,
		Offset: 1,
		MintOffset: 1000000,
